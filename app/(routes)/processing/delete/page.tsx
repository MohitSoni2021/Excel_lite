  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center bg-green-50">
      <div className="text-center">
        ...
        <h1 className="text-3xl font-bold text-green-600 mb-4">Successfully Deleted</h1>
        <p className="text-lg text-gray-700">
          The item has been successfully deleted. You will be redirected to the dashboard in 3 seconds.
        </p>
